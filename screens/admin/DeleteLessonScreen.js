...
const DeleteLessonScreen = ({ navigation }) => {
  const isAdmin = true;

  const handleCategoryPress = (category) => {
    navigation.navigate(category, { isAdmin, mode: 'delete' });
  };
    ...
    <View style={commonStyles.homeContainer}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={globalStyles.pb40}>
          ...
          <Text style={[commonStyles.welcomeText, globalStyles.textLeft, globalStyles.mt58, globalStyles.mb0]}>Remove Lessons</Text>
          ...
          <View style={[commonStyles.cardContainer, globalStyles.mt24]}>
            ...
            >
              ...
              <View style={commonStyles.categoryCardContent}>
                ...
                <Text style={commonStyles.categoryCardDescription}>
                  Choose a Listening lesson to delete
                </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={commonStyles.categoryCardContent}>
                ...
                <Text style={commonStyles.categoryCardDescription}>
                  Choose a Speaking lesson to delete
                </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={commonStyles.categoryCardContent}>
                ...
                <Text style={commonStyles.categoryCardDescription}>
                  Choose a Reading lesson to delete
                </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={commonStyles.categoryCardContent}>
                ...
                <Text style={commonStyles.categoryCardDescription}>
                  Choose a Writing lesson to delete
                </Text>
              </View>
            </TouchableOpacity>
          </View>
...
export default DeleteLessonScreen;
